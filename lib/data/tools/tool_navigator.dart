...
class ToolNavigator {
  ...
  static Future<void> pushHero(Widget screen) async {
    Navigator.push(App.navigatorKey.currentContext!, _createHeroFadeRoute(screen));
  }
  ...
  static Route _createHeroFadeRoute(Widget widget) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => widget,
      barrierDismissible: true,
      opaque: false,
